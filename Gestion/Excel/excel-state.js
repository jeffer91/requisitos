...
- Emitir eventos para actualizar UI sin recargar la pantalla.
- Guardar estado temporal de seguridad antes de permitir Guardar.
Con qué se conecta:
- excel-ui.cargar.js
- excel-ui.resumen.js
========================================================= */
(function(window){
  "use strict";
  function initial(){return {periodoId:"",periodoLabel:"",fileName:"",headers:[],rows:[],schema:null,analisis:null,consolidado:null,seguridad:null,saveStatus:null,lastError:null,lastAction:null};}
  var state=initial();
  var listeners={};
  ...
  function reset(){state=initial();emit("reset",null);return copy();}
