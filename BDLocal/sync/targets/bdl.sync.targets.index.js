...
(function(window){
  ...
  function fetchJson(
    ...
    if (!window.fetch){
      return Promise.reject(
        new Error(
          "fetch no disponible en este entorno."
        )
      );
    }
    ...
    return fetch(
      ...
      .catch(function(error){
        if (
          ...
          throw new Error(
            "Tiempo agotado en sincronización externa."
          );
        }
  ...
  function sheetsConfig(){
    ...
    if (
      !current ||
      typeof current.getSheetsConfig !==
        "function"
    ){
      throw new Error(
        "BDLocalConfigStore.getSheetsConfig no está disponible."
      );
    }

    var config =
      current.getSheetsConfig({
        includeSecret: true
      }) || {};

    if (!config.enabled){
      throw new Error(
        "Google Sheets está desactivado en la configuración."
      );
    }
    ...
    if (!text(config.token)){
      throw new Error(
        "Falta la credencial de Apps Script."
      );
    }
  ...
  function supabaseConfig(){
    ...
    if (
      !current ||
      typeof current.getSupabaseConfig !==
        "function"
    ){
      throw new Error(
        "BDLocalConfigStore.getSupabaseConfig no está disponible."
      );
    }

    var config =
      current.getSupabaseConfig({
        includeSecret: true
      }) || {};

    if (!config.enabled){
      throw new Error(
        "Supabase está desactivado en la configuración."
      );
    }
    ...
    if (
      ...
      throw new Error(
        "Falta la clave de acceso de Supabase."
      );
    }
  ...
  function buildGoogleTables(
    ...
    return Promise.all(
      keys.map(function(key){
        ...
        if (
          currentCore &&
          typeof currentCore.getStudentByCedula ===
            "function"
        ){
          return currentCore
            .getStudentByCedula(
  ...
  function pushGoogleRows(
    ...
    if (
      ...
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Google Sheets solo admite subida manual."
      });
    }
    ...
    if (!rows.length){
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Google Sheets: no hay cambios para enviar."
      });
    }
    ...
    if (
      ...
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Seleccione un período antes de subir a Google Sheets."
      });
    }
  ...
  function pushSupabaseRows(
    ...
    if (
      ...
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Supabase solo admite subida manual."
      });
    }
    ...
    if (!rows.length){
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Supabase: no hay cambios para enviar."
      });
    }
    ...
    if (
      ...
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "Seleccione un período antes de subir a Supabase."
      });
    }
    ...
    if (!records.length){
      return Promise.resolve({
        ...
        processedIds: [],
        message:
          "No existen registros válidos para Supabase."
      });
    }
