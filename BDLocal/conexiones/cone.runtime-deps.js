...
(function(window,document){
  ...
  profiles.defensas=[
    ...
    {path:"../rules/bdl.rules.requisitos.js",test:function(){return window.BDLRulesRequisitos;}},
    {path:"../rules/bdl.rules.notas.js",test:function(){return window.BDLRulesNotas;}},
    {path:"../rules/bdl.rules.defense-eligibility.js",test:function(){return window.BDLDefenseEligibility;}},
