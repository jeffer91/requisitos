...
if(!changed){
  ...
  /*
   * El estudiante legacy puede existir mientras su registro V2
   * todavía no fue creado. Confirmar nuevamente esta fila activa
   * BDLV2Mirror para reconstruir personas y matriculas_periodo.
   */
  return db.put(
    STORE.estudiantes,
    cleanStudentForStore(existing || student)
  ).then(function(){
