...
(function(window){
  ...
  window.InPVCUtils={text:text,esc:esc,number:number,pct:pct,note:note,slug:slug,download:download,table:table,barChart:barChart,registerSection:registerSection};
})(window);
